...
#    os.system('scp *.root cctrack@vocms061:/data/users/event_display/TkCommissioner_runs/'+DataLocalDir+'/'+dest)
    ...
    ssh2 = subprocess.Popen(["ssh", "%s" % HOST, Command2],
                       ...
                       stderr=subprocess.PIPE)
    ssh2.stdout
    ssh3 = subprocess.Popen(["ssh", "%s" % HOST, Command3],
                       shell=False,
                        stdout=subprocess.PIPE,
                       stderr=subprocess.PIPE)
    ssh3.stdout
    ...
    os.system('scp -r * cctrack@vocms062:/data/users/event_display/'+DataLocalDir+'/'+dest+'/'+str(nnnOut)+'/'+str(Run_Number[i])+'/'+Run_type+'/SiStrip')
#    os.system('scp -r * cctrack@vocms061:/data/users/event_display/'+DataLocalDir+'/'+dest+'/'+str(nnn)+'/'+str(Run_Number[i])+'/'+Run_type)
    ...
    os.system('scp -r OUT/* cctrack@vocms062:/data/users/event_display/'+DataLocalDir+'/'+dest+'/'+str(nnnOut)+'/'+str(Run_Number[i])+'/'+Run_type+'/Pixel')
    shutil.rmtree('OUT')
